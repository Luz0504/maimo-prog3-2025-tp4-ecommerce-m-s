  ...
  return (
    <div className="col-span-3 flex bg-white rounded-2xl gap-1 border-black border-[2px] text-black transition-transform duration-300 ease-in-out hover:scale-105 items-center">
      ...
      <section>
        ...
        ease-in-out hover:bg-blue-500 hover:cursor-pointer text-center text-[1.25em]
      ...
      >
        Ver más
                ...
                <section className="flex justify-center gap-1 items-center mx-1">
                  {qty == 1?
                  <button onClick={() => addToCart(product.name, product.price, product.img, product._id, -1)} className="text-2xl p-1 h-fit rounded-2xl border-2 border-black
                  bg-fuchsia-400 hover:text-white cursor-pointer hover:bg-fuchsia-900
                  inset-ring-2 inset-ring-fuchsia-300
                  hover:inset-ring-fuchsia-600 disabled:opacity-50" disabled>-</button>
                  :
                  <button onClick={() => addToCart(product.name, product.price, product.img, product._id, -1)} className="text-2xl p-1 h-fit rounded-2xl border-2 border-black
                  bg-fuchsia-400 hover:text-white cursor-pointer hover:bg-fuchsia-900
                  inset-ring-2 inset-ring-fuchsia-300
                  hover:inset-ring-fuchsia-600">-</button>
                  }  
